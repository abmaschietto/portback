...
public class CursoController {
	...
	public ResponseEntity<String> insertCurso(@RequestBody @Valid CursoForm curso) throws CursoInvalidoException{
		cursoService.saveCurso(curso);
		return ResponseEntity.ok("Curso salvo");
	}
	
	@GetMapping(path = "/recoverId")
	public ResponseEntity<Long> recoverId(@RequestParam String certificado) throws CursoInvalidoException{
		return ResponseEntity.ok(cursoService.recoverId(certificado));
	}
	
	@PutMapping(path = "/atualizarByCertificado")
	public ResponseEntity<String> updateCurso(@RequestBody CursoForm curso) throws CursoInvalidoException{
		cursoService.updateCurso(curso);
		return ResponseEntity.ok("Curso atualizado pelo certificado");
	}
	
	@PutMapping(path = "/atualizarById/{id}")
	public ResponseEntity<String> updateCurso(@PathVariable Long id, @RequestBody CursoForm curso) throws CursoInvalidoException{
