...
public class CursoService {
	...
	public void updateCurso(CursoForm curso) throws CursoInvalidoException {
	...
	public void updateCurso(Long id, CursoForm curso) throws CursoInvalidoException {
		CursoVO originalCurso = cursoRepo.findById(id).orElseThrow(() -> new CursoInvalidoException("Nenhum curso encontrado com este Id"));
		cursoRepo.save(originalCurso.updateCurso(curso));
	}
	
	public Long recoverId(String certificado) throws CursoInvalidoException {
		return cursoRepo.findByUrlCertificado(certificado).map(CursoVO::getId).orElseThrow(() -> new CursoInvalidoException("Nenhum curso encontrado com este certificado"));
	}
